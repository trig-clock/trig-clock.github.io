		...
		$m['VMLContext'] = (function(){
			...
			$method = $pyjs__bind_method2('__init__', function(ctx) {
				...
				if ((function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['bool']($p['op_is'](ctx, null));
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_1_err){if (!$p['isinstance']($pyjs_dbg_1_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_1_err);}throw $pyjs_dbg_1_err;
}})()) {
					$pyjs['track']['lineno']=46;
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('matrix', (function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['list']([$constant_int_1, $constant_int_0, $constant_int_0, $constant_int_0, $constant_int_1, $constant_int_0, $constant_int_0, $constant_int_0, $constant_int_1]);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_2_err){if (!$p['isinstance']($pyjs_dbg_2_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_2_err);}throw $pyjs_dbg_2_err;
}})()) : $p['setattr'](self, 'matrix', (function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['list']([$constant_int_1, $constant_int_0, $constant_int_0, $constant_int_0, $constant_int_1, $constant_int_0, $constant_int_0, $constant_int_0, $constant_int_1]);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_2_err){if (!$p['isinstance']($pyjs_dbg_2_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_2_err);}throw $pyjs_dbg_2_err;
}})()); 
					...
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('strokeStyle', (function(){try{try{$pyjs['in_try_except'] += 1;
					return $m['VMLStyle']();
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_3_err){if (!$p['isinstance']($pyjs_dbg_3_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_3_err);}throw $pyjs_dbg_3_err;
}})()) : $p['setattr'](self, 'strokeStyle', (function(){try{try{$pyjs['in_try_except'] += 1;
					return $m['VMLStyle']();
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_3_err){if (!$p['isinstance']($pyjs_dbg_3_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_3_err);}throw $pyjs_dbg_3_err;
}})()); 
					$pyjs['track']['lineno']=59;
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('fillStyle', (function(){try{try{$pyjs['in_try_except'] += 1;
					return $m['VMLStyle']();
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_4_err){if (!$p['isinstance']($pyjs_dbg_4_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_4_err);}throw $pyjs_dbg_4_err;
}})()) : $p['setattr'](self, 'fillStyle', (function(){try{try{$pyjs['in_try_except'] += 1;
					return $m['VMLStyle']();
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_4_err){if (!$p['isinstance']($pyjs_dbg_4_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_4_err);}throw $pyjs_dbg_4_err;
}})()); 
				...
				while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
					...
					return self['matrix']['append']($p['getattr'](ctx, 'matrix')['__getitem__'](i));
