...
$pyjs['loaded_modules']['pyjamas.ui.ClickListener'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['listener']]);
			...
			$method = $pyjs__bind_method2('addClickListener', function(listener) {
				...
				stylename = (function(){try{try{$pyjs['in_try_except'] += 1;
				return self['getStyleName']();
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_6_err){if (!$p['isinstance']($pyjs_dbg_6_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_6_err);}throw $pyjs_dbg_6_err;
}})();
				$pyjs['track']['lineno']=29;
				if ((function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['bool'](stylename);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_7_err){if (!$p['isinstance']($pyjs_dbg_7_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_7_err);}throw $pyjs_dbg_7_err;
}})()) {
					$pyjs['track']['lineno']=30;
					(function(){try{try{$pyjs['in_try_except'] += 1;
					return self['addStyleName']((function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['sprintf']('%s-clickable', (function(){try{try{$pyjs['in_try_except'] += 1;
