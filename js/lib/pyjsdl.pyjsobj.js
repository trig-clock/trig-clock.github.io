...
$pyjs['loaded_modules']['pyjsdl.pyjsobj'] = function (__mod_name__) {
	...
	try {
		...
		$m.__track_lines__[36] = 'pyjsdl.pyjsobj.py, line 36:\n    requestAnimationFramePolyfill = JS("""';
		$m.__track_lines__[27] = 'pyjsdl.pyjsobj.py, line 27:\n    def requestAnimationFrameInit():';
		$m.__track_lines__[28] = 'pyjsdl.pyjsobj.py, line 28:\n    requestAnimationFramePolyfill()';
		$m.__track_lines__[29] = 'pyjsdl.pyjsobj.py, line 29:\n    return wnd()';
    ...
    return Math['round'](-evt['wheelDelta'] / 40) || 0;
		...
		$m['requestAnimationFrameInit'] = function() {
			...
			$pyjs['track']={'module':'pyjsdl.pyjsobj','lineno':27};$pyjs['trackstack']['push']($pyjs['track']);
			$pyjs['track']['module']='pyjsdl.pyjsobj';
			$pyjs['track']['lineno']=27;
			$pyjs['track']['lineno']=28;
			(function(){try{try{$pyjs['in_try_except'] += 1;
			return (typeof requestAnimationFramePolyfill == "undefined"?$m['requestAnimationFramePolyfill']:requestAnimationFramePolyfill)();
