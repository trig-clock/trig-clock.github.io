			...
			$method = $pyjs__bind_method2('applyValues', function() {
				...
				return $p['__ass_unpack']($iter3_nextval['$nextval'], 2, null);
					...
					if ((function(){try{try{$pyjs['in_try_except'] += 1;
						...
						return $p['sprintf']('setter function for %s does not exist in %s', (function(){try{try{$pyjs['in_try_except'] += 1;
						return $p['tuple']([prop, $p['getattr']($p['getattr'](self, '__class__'), '__name__')]);
