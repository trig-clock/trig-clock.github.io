/* start module: relogio_web */
$pyjs['loaded_modules']['relogio_web'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['relogio_web']['__was_initialized__']) return $pyjs['loaded_modules']['relogio_web'];
	var $m = $pyjs['loaded_modules']['relogio_web'];
	$m['__repr__'] = function() { return '<module: relogio_web>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'relogio_web';
