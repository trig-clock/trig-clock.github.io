...
$pyjs['loaded_modules']['pyjamas.Canvas.GWTCanvasImplDefault'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('arc', function(x, y, radius, startAngle, endAngle, antiClockwise) {
				...
				return self['canvasContext']['arc'](x, y, radius, startAngle, endAngle, antiClockwise);
	...
	, 1, [null,null,['self'],['x'],['y'],['radius'],['startAngle'],['endAngle'],['antiClockwise']]);
			...
			$method = $pyjs__bind_method2('beginPath', function() {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['beginPath']();
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('clear', function(width, height) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['clearRect']($constant_int_0, $constant_int_0, width, height);
	...
	, 1, [null,null,['self'],['width'],['height']]);
			...
			$method = $pyjs__bind_method2('closePath', function() {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['closePath']();
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('createElement', function() {
				...
				return $m['DOM']['createElement']('CANVAS');
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_5_err){if (!$p['isinstance']($pyjs_dbg_5_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_5_err);}throw $pyjs_dbg_5_err;
}})();
				$pyjs['track']['lineno']=50;
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['setCanvasContext']((function(){try{try{$pyjs['in_try_except'] += 1;
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('cubicCurveTo', function(cp1x, cp1y, cp2x, cp2y, x, y) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['bezierCurveTo'](cp1x, cp1y, cp2x, cp2y, x, y);
				...
				try {
					try {
						...
						if ((function(){try{try{$pyjs['in_try_except'] += 1;
							return $p['bool']($p['op_is'](maxWidth, null));
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_9_err){if (!$p['isinstance']($pyjs_dbg_9_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_9_err);}throw $pyjs_dbg_9_err;
}})()) {
							$pyjs['track']['lineno']=66;
							(function(){try{try{$pyjs['in_try_except'] += 1;
							return self['canvasContext']['fillText'](text, sourceX, sourceY);
							...
							(function(){try{try{$pyjs['in_try_except'] += 1;
							return self['canvasContext']['fillText'](text, sourceX, sourceY, maxWidth);
					...
					if (true) {
						...
						(function(){try{try{$pyjs['in_try_except'] += 1;
						return self['translate'](sourceX, sourceY);
						...
						try {
							try {
								...
								return (typeof unicode == "undefined"?$m['unicode']:unicode)(text);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_14_err){if (!$p['isinstance']($pyjs_dbg_14_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_14_err);}throw $pyjs_dbg_14_err;
}})();
								$pyjs['track']['lineno']=74;
								(function(){try{try{$pyjs['in_try_except'] += 1;
								return self['canvasContext']['mozDrawText'](text);
							...
							if (true) {
								...
								(function(){try{try{$pyjs['in_try_except'] += 1;
								return self['canvasContext']['drawText'](text);
	...
	, 1, [null,null,['self'],['text'],['sourceX'],['sourceY'],['maxWidth', null]]);
			...
			$method = $pyjs__bind_method2('drawImage', function(img, sourceX, sourceY, sourceWidth, sourceHeight, destX, destY, destWidth, destHeight) {
				...
				if ((function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['bool']($p['op_is'](sourceWidth, null));
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_21_err){if (!$p['isinstance']($pyjs_dbg_21_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_21_err);}throw $pyjs_dbg_21_err;
}})()) {
					$pyjs['track']['lineno']=84;
					(function(){try{try{$pyjs['in_try_except'] += 1;
					return self['canvasContext']['drawImage'](img, sourceX, sourceY);
					...
					(function(){try{try{$pyjs['in_try_except'] += 1;
					return self['canvasContext']['drawImage'](img, sourceX, sourceY, sourceWidth, sourceHeight, destX, destY, destWidth, destHeight);
	...
	, 1, [null,null,['self'],['img'],['sourceX'],['sourceY'],['sourceWidth', null],['sourceHeight', null],['destX', null],['destY', null],['destWidth', null],['destHeight', null]]);
			...
			$method = $pyjs__bind_method2('fill', function() {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['fill']();
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('fillRect', function(startX, startY, width, height) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['fillRect'](startX, startY, width, height);
	...
	, 1, [null,null,['self'],['elem']]);
			...
			$method = $pyjs__bind_method2('lineTo', function(x, y) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['lineTo'](x, y);
	...
	, 1, [null,null,['self'],['x'],['y']]);
			...
			$method = $pyjs__bind_method2('moveTo', function(x, y) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['moveTo'](x, y);
	...
	, 1, [null,null,['self'],['x'],['y']]);
			...
			$method = $pyjs__bind_method2('quadraticCurveTo', function(cpx, cpy, x, y) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['quadraticCurveTo'](cpx, cpy, x, y);
	...
	, 1, [null,null,['self'],['cpx'],['cpy'],['x'],['y']]);
			...
			$method = $pyjs__bind_method2('rect', function(x, y, width, height) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['rect'](x, y, width, height);
	...
	, 1, [null,null,['self'],['x'],['y'],['width'],['height']]);
			...
			$method = $pyjs__bind_method2('restoreContext', function() {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['restore']();
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('rotate', function(angle) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['rotate'](angle);
	...
	, 1, [null,null,['self'],['angle']]);
			...
			$method = $pyjs__bind_method2('saveContext', function() {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['save']();
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('scale', function(x, y) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['scale'](x, y);
	...
	, 1, [null,null,['self'],['element'],['color']]);
			...
			$method = $pyjs__bind_method2('setCoordHeight', function(elem, height) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['DOM']['setElemAttribute'](elem, 'height', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $p['str'](height);
	...
	, 1, [null,null,['self'],['elem'],['width']]);
			...
			$method = $pyjs__bind_method2('setStrokeStyle', function(gradient) {
				...
				$p['getattr'](self, 'canvasContext')['__is_instance__'] && typeof $p['getattr'](self, 'canvasContext')['__setattr__'] == 'function' ? $p['getattr'](self, 'canvasContext')['__setattr__']('strokeStyle', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['cvt'](gradient);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_47_err){if (!$p['isinstance']($pyjs_dbg_47_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_47_err);}throw $pyjs_dbg_47_err;
}})()) : $p['setattr']($p['getattr'](self, 'canvasContext'), 'strokeStyle', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['cvt'](gradient);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_47_err){if (!$p['isinstance']($pyjs_dbg_47_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_47_err);}throw $pyjs_dbg_47_err;
}})()); 
				$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
	...
	, 1, [null,null,['self'],['gradient']]);
			...
			$method = $pyjs__bind_method2('setFillStyle', function(gradient) {
				...
				$p['getattr'](self, 'canvasContext')['__is_instance__'] && typeof $p['getattr'](self, 'canvasContext')['__setattr__'] == 'function' ? $p['getattr'](self, 'canvasContext')['__setattr__']('fillStyle', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['cvt'](gradient);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_54_err){if (!$p['isinstance']($pyjs_dbg_54_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_54_err);}throw $pyjs_dbg_54_err;
}})()) : $p['setattr']($p['getattr'](self, 'canvasContext'), 'fillStyle', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['cvt'](gradient);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_54_err){if (!$p['isinstance']($pyjs_dbg_54_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_54_err);}throw $pyjs_dbg_54_err;
}})()); 
				$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
	...
	, 1, [null,null,['self'],['alpha']]);
			...
			$method = $pyjs__bind_method2('setGlobalCompositeOperation', function(globalCompositeOperation) {
				...
				$p['getattr'](self, 'canvasContext')['__is_instance__'] && typeof $p['getattr'](self, 'canvasContext')['__setattr__'] == 'function' ? $p['getattr'](self, 'canvasContext')['__setattr__']('globalCompositeOperation', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['cvt'](globalCompositeOperation);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_55_err){if (!$p['isinstance']($pyjs_dbg_55_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_55_err);}throw $pyjs_dbg_55_err;
}})()) : $p['setattr']($p['getattr'](self, 'canvasContext'), 'globalCompositeOperation', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['cvt'](globalCompositeOperation);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_55_err){if (!$p['isinstance']($pyjs_dbg_55_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_55_err);}throw $pyjs_dbg_55_err;
}})()); 
				$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
	...
	, 1, [null,null,['self'],['globalCompositeOperation']]);
			...
			$method = $pyjs__bind_method2('setLineCap', function(lineCap) {
				...
				$p['getattr'](self, 'canvasContext')['__is_instance__'] && typeof $p['getattr'](self, 'canvasContext')['__setattr__'] == 'function' ? $p['getattr'](self, 'canvasContext')['__setattr__']('lineCap', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['cvt'](lineCap);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_56_err){if (!$p['isinstance']($pyjs_dbg_56_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_56_err);}throw $pyjs_dbg_56_err;
}})()) : $p['setattr']($p['getattr'](self, 'canvasContext'), 'lineCap', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['cvt'](lineCap);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_56_err){if (!$p['isinstance']($pyjs_dbg_56_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_56_err);}throw $pyjs_dbg_56_err;
}})()); 
				$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
	...
	, 1, [null,null,['self'],['lineCap']]);
			...
			$method = $pyjs__bind_method2('setLineJoin', function(lineJoin) {
				...
				$p['getattr'](self, 'canvasContext')['__is_instance__'] && typeof $p['getattr'](self, 'canvasContext')['__setattr__'] == 'function' ? $p['getattr'](self, 'canvasContext')['__setattr__']('lineJoin', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['cvt'](lineJoin);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_57_err){if (!$p['isinstance']($pyjs_dbg_57_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_57_err);}throw $pyjs_dbg_57_err;
}})()) : $p['setattr']($p['getattr'](self, 'canvasContext'), 'lineJoin', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['cvt'](lineJoin);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_57_err){if (!$p['isinstance']($pyjs_dbg_57_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_57_err);}throw $pyjs_dbg_57_err;
}})()); 
				$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
	...
	, 1, [null,null,['self'],['miterLimit']]);
			...
			$method = $pyjs__bind_method2('setPixelHeight', function(elem, height) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['DOM']['setStyleAttribute'](elem, 'height', (function(){try{try{$pyjs['in_try_except'] += 1;
	...
	, 1, [null,null,['self'],['elem'],['height']]);
			...
			$method = $pyjs__bind_method2('setPixelWidth', function(elem, width) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['DOM']['setStyleAttribute'](elem, 'width', (function(){try{try{$pyjs['in_try_except'] += 1;
	...
	, 1, [null,null,['self'],['elem'],['width']]);
			...
			$method = $pyjs__bind_method2('stroke', function() {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['stroke']();
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('strokeRect', function(startX, startY, width, height) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['strokeRect'](startX, startY, width, height);
	...
	, 1, [null,null,['self'],['startX'],['startY'],['width'],['height']]);
			...
			$method = $pyjs__bind_method2('transform', function(m11, m12, m21, m22, dx, dy) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['transform'](m11, m12, m21, m22, dx, dy);
	...
	, 1, [null,null,['self'],['m11'],['m12'],['m21'],['m22'],['dx'],['dy']]);
			...
			$method = $pyjs__bind_method2('translate', function(x, y) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['translate'](x, y);
	...
	, 1, [null,null,['self'],['x'],['y']]);
			...
			$method = $pyjs__bind_method2('clearRect', function(startX, startY, width, height) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['canvasContext']['clearRect'](startX, startY, width, height);
