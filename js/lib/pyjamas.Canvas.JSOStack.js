...
$pyjs['loaded_modules']['pyjamas.Canvas.JSOStack'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('clear', function() {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('scratch', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $p['list']([]);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_2_err){if (!$p['isinstance']($pyjs_dbg_2_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_2_err);}throw $pyjs_dbg_2_err;
}})()) : $p['setattr'](self, 'scratch', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $p['list']([]);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_2_err){if (!$p['isinstance']($pyjs_dbg_2_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_2_err);}throw $pyjs_dbg_2_err;
}})()); 
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('logCoordX', function(coordX) {
				...
				if ((function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['bool']($p['op_is']($p['getattr'](self, '_minX'), null));
					...
					if ((function(){try{try{$pyjs['in_try_except'] += 1;
						return $p['bool'](($p['cmp']($p['getattr'](self, '_minX'), coordX) == 1));
						...
						if ((function(){try{try{$pyjs['in_try_except'] += 1;
							return $p['bool'](($p['cmp']($p['getattr'](self, '_maxX'), coordX) == -1));
	...
	, 1, [null,null,['self'],['coordX']]);
			...
			$method = $pyjs__bind_method2('logCoordY', function(coordY) {
				...
				if ((function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['bool']($p['op_is']($p['getattr'](self, '_minY'), null));
					...
					if ((function(){try{try{$pyjs['in_try_except'] += 1;
						return $p['bool'](($p['cmp']($p['getattr'](self, '_minY'), coordY) == 1));
						...
						if ((function(){try{try{$pyjs['in_try_except'] += 1;
							return $p['bool'](($p['cmp']($p['getattr'](self, '_maxY'), coordY) == -1));
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('append', function(pathStr) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['scratch']['append'](pathStr);
