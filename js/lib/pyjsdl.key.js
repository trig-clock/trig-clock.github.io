	...
	try {
		...
		$m['Key'] = (function(){
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('_keys', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $p['dict']([]);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_1_err){if (!$p['isinstance']($pyjs_dbg_1_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_1_err);}throw $pyjs_dbg_1_err;
}})()) : $p['setattr'](self, '_keys', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $p['dict']([]);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_1_err){if (!$p['isinstance']($pyjs_dbg_1_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_1_err);}throw $pyjs_dbg_1_err;
}})()); 
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('$$name', function(keycode) {
				...
				if ((function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['bool'](!$p['bool']($p['getattr'](self, '_keys')));
					...
					while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
						...
						return keyname['startswith']('K_');
							...
							(function(){try{try{$pyjs['in_try_except'] += 1;
							return $p['getattr'](self, '_keys')['__setitem__']((function(){try{try{$pyjs['in_try_except'] += 1;
							return $p['getattr']($m['Const'], keyname);
					...
					(function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['getattr'](self, '_keys')['__setitem__']($constant_int_0, 'unknown key');
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_12_err){if (!$p['isinstance']($pyjs_dbg_12_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_12_err);}throw $pyjs_dbg_12_err;
}})();
				}
				$pyjs['track']['lineno']=41;
				if ((function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['bool'](!$p['getattr'](self, '_keys')['__contains__'](keycode));
