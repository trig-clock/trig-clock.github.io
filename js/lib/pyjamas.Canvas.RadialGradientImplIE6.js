...
$pyjs['loaded_modules']['pyjamas.Canvas.RadialGradientImplIE6'] = function (__mod_name__) {
	...
	try {
		...
		$m['RadialGradientImplIE6'] = (function(){
			...
			$method = $pyjs__bind_method2('__init__', function(x0, y0, r0, x1, y1, r1) {
				...
				return $m['CanvasGradientImplIE6']['__init__'](self, x0, y0, x1, y1);
	...
	, 1, [null,null,['self'],['x0'],['y0'],['r0'],['x1'],['y1'],['r1']]);
			...
			$method = $pyjs__bind_method2('cloneGradient', function() {
				...
				newGrad = (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['RadialGradientImplIE6']($p['getattr'](self, 'startX'), $p['getattr'](self, 'startY'), $p['getattr'](self, 'startRad'), $p['getattr'](self, 'endX'), $p['getattr'](self, 'endY'), $p['getattr'](self, 'endRad'));
				...
				while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
					...
					(function(){try{try{$pyjs['in_try_except'] += 1;
					return newGrad['colorStops']['append']((function(){try{try{$pyjs['in_try_except'] += 1;
					return cStops['__getitem__'](i)['cloneColorStop']();
