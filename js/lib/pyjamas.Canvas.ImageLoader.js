...
$pyjs['loaded_modules']['pyjamas.Canvas.ImageLoader'] = function (__mod_name__) {
	...
	try {
		...
		$m['imageLoaders'] = (function(){try{try{$pyjs['in_try_except'] += 1;
		return $p['list']([]);
	...
	, 1, [null,null,['self'],['img']]);
			...
			$method = $pyjs__bind_method2('dispatchIfComplete', function() {
				...
				if ((function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['bool'](($p['bool']($and1=!$p['op_is']($p['getattr'](self, 'callBack'), null))?(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['isAllLoaded']();
					...
					(function(){try{try{$pyjs['in_try_except'] += 1;
					return self['callBack']['onImagesLoaded']($p['getattr'](self, 'images'));
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_6_err){if (!$p['isinstance']($pyjs_dbg_6_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_6_err);}throw $pyjs_dbg_6_err;
}})();
					$pyjs['track']['lineno']=67;
					(function(){try{try{$pyjs['in_try_except'] += 1;
					return $m['imageLoaders']['remove'](self);
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('prepareImage', function(url) {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return img['addLoadListener'](self);
	...
	, 1, [null,null,['self'],['url']]);
			...
			$method = $pyjs__bind_method2('onLoad', function(img) {
				...
				if ((function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['bool'](!$p['bool']($p['getattr'](img, '__isLoaded')));
					...
					(function(){try{try{$pyjs['in_try_except'] += 1;
					return self['incrementLoadedImages']();
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_15_err){if (!$p['isinstance']($pyjs_dbg_15_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_15_err);}throw $pyjs_dbg_15_err;
}})();
					$pyjs['track']['lineno']=114;
					(function(){try{try{$pyjs['in_try_except'] += 1;
					return img['removeLoadListener'](self);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_16_err){if (!$p['isinstance']($pyjs_dbg_16_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_16_err);}throw $pyjs_dbg_16_err;
}})();
				}
				$pyjs['track']['lineno']=118;
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['dispatchIfComplete']();
	...
	, 1, [null,null,['self'],['img']]);
		...
		$m['loadImages'] = function(urls, cb) {
			...
			il = (function(){try{try{$pyjs['in_try_except'] += 1;
			...
			while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return il['addHandle']((function(){try{try{$pyjs['in_try_except'] += 1;
				return il['prepareImage'](urls['__getitem__'](i));
			...
			(function(){try{try{$pyjs['in_try_except'] += 1;
			return il['finalize'](cb);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_24_err){if (!$p['isinstance']($pyjs_dbg_24_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_24_err);}throw $pyjs_dbg_24_err;
}})();
			$pyjs['track']['lineno']=140;
			(function(){try{try{$pyjs['in_try_except'] += 1;
			return $m['imageLoaders']['append'](il);
			...
			while (typeof($p['__wrapped_next']($iter2_nextval)['$nextval']) != 'undefined') {
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return $p['getattr'](il, 'images')['__getitem__'](i)['setUrl'](urls['__getitem__'](i));
