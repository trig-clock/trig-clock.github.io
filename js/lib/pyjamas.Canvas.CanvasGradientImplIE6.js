...
$pyjs['loaded_modules']['pyjamas.Canvas.CanvasGradientImplIE6'] = function (__mod_name__) {
	...
	try {
		...
		$m['CanvasGradientImplIE6'] = (function(){
			...
			$method = $pyjs__bind_method2('__init__', function(x0, y0, x1, y1) {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('length', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['math']['sqrt']($p['__op_add']($add1=(typeof ($mul1=$p['getattr'](self, 'dx'))==typeof ($mul2=$p['getattr'](self, 'dx')) && typeof $mul1=='number'?
					$mul1*$mul2:
...
}})()) : $p['setattr'](self, 'length', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['math']['sqrt']($p['__op_add']($add1=(typeof ($mul1=$p['getattr'](self, 'dx'))==typeof ($mul2=$p['getattr'](self, 'dx')) && typeof $mul1=='number'?
					$mul1*$mul2:
					$p['op_mul']($mul1,$mul2)),$add2=(typeof ($mul3=$p['getattr'](self, 'dy'))==typeof ($mul4=$p['getattr'](self, 'dy')) && typeof $mul3=='number'?
					$mul3*$mul4:
				...
				if ((function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['bool']($p['op_eq']($p['getattr'](self, 'dy'), $constant_int_0));
					...
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('angle', $p['__op_add']($add3=(function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['int']((typeof ($div3=(typeof ($mul5=(function(){try{try{$pyjs['in_try_except'] += 1;
					return $m['math']['atan']((typeof ($div1=$p['getattr'](self, 'dx'))==typeof ($div2=$p['getattr'](self, 'dy')) && typeof $div1=='number' && $div2 !== 0?
						$div1/$div2:
						$p['op_div']($div1,$div2)));
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_3_err){if (!$p['isinstance']($pyjs_dbg_3_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_3_err);}throw $pyjs_dbg_3_err;
}})())==typeof ($mul6=$constant_int_180) && typeof $mul5=='number'?
						$mul5*$mul6:
						$p['op_mul']($mul5,$mul6)))==typeof ($div4=$p['getattr']($m['math'], 'pi')) && typeof $div3=='number' && $div4 !== 0?
						$div3/$div4:
						$p['op_div']($div3,$div4)));
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_4_err){if (!$p['isinstance']($pyjs_dbg_4_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_4_err);}throw $pyjs_dbg_4_err;
}})(),$add4=$constant_int_180)) : $p['setattr'](self, 'angle', $p['__op_add']($add3=(function(){try{try{$pyjs['in_try_except'] += 1;
					return $p['int']((typeof ($div3=(typeof ($mul5=(function(){try{try{$pyjs['in_try_except'] += 1;
					return $m['math']['atan']((typeof ($div1=$p['getattr'](self, 'dx'))==typeof ($div2=$p['getattr'](self, 'dy')) && typeof $div1=='number' && $div2 !== 0?
						$div1/$div2:
						$p['op_div']($div1,$div2)));
...
}})(),$add4=$constant_int_180)); 
				}
				$pyjs['track']['lineno']=44;
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('colorStops', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $p['list']([]);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_5_err){if (!$p['isinstance']($pyjs_dbg_5_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_5_err);}throw $pyjs_dbg_5_err;
}})()) : $p['setattr'](self, 'colorStops', (function(){try{try{$pyjs['in_try_except'] += 1;
				return $p['list']([]);
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_5_err){if (!$p['isinstance']($pyjs_dbg_5_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_5_err);}throw $pyjs_dbg_5_err;
}})()); 
				$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
	...
	, 1, [null,null,['self'],['x0'],['y0'],['x1'],['y1']]);
			...
			$method = $pyjs__bind_method2('addColorStop', function(offset, color) {
				...
				newColorStop = (function(){try{try{$pyjs['in_try_except'] += 1;
				return $m['ColorStop'](offset, color);
				...
				return $p['len']($p['getattr'](self, 'colorStops'));
				...
				while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
					...
					if ((function(){try{try{$pyjs['in_try_except'] += 1;
						return $p['bool'](($p['cmp'](offset, $p['getattr'](cs, 'offset')) == -1));
}finally{$pyjs['in_try_except']-=1;}}catch($pyjs_dbg_10_err){if (!$p['isinstance']($pyjs_dbg_10_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_10_err);}throw $pyjs_dbg_10_err;
}})()) {
						$pyjs['track']['lineno']=51;
						(function(){try{try{$pyjs['in_try_except'] += 1;
						return self['colorStops']['append'](i, newColorStop);
				...
				(function(){try{try{$pyjs['in_try_except'] += 1;
				return self['colorStops']['append'](newColorStop);
